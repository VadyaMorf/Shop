...
namespace Shop.Application.Services
{
    public class ProductService : IProductService
    {
        ...
        public async Task<Guid> UpdateProduct(Guid id, string title, string description, decimal price, byte[] image, string size, decimal count)
        {
            return await _repository.Update(id, title, description, price, image, size, count);
        }
