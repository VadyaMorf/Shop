...
namespace Shop.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<ProductsResponse>>> GetProducts()
        {
            ...
            var response = products.Select(b => new ProductsResponse(b.Id, b.Title, b.Description, b.Price, b.Image,b.Size, b.Count));
        ...
        {
            var productId = await _productService.UpdateProduct(id, request.Title, request.Description, request.Price, request.Image, request.Size, request.Count);
