...
namespace Shop.DataAccess.Repositiries
{
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<List<Product>> Get()
        {
            ...
            var products = productEntities.Select(b => Product.Create(b.Id, b.Title, b.Description, b.Price, b.Image,b.Size, b.Count).Product).ToList();
        ...
        public async Task<Guid> Update(Guid id, string title, string descriprion, decimal price, byte[] image, string size, decimal count)
        {
